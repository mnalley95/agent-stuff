...
This stage decomposes old RPI **Plan** into the outline substage: turn the approved design into vertical phases, checkpoints, and validation shape before writing detailed implementation instructions.
...
Next step: start a fresh session with `qrspi/skills/v2/create_plan.md`.
