...
This stage decomposes the old RPI **Research** step into the first half: turn a task/ticket into objective questions that a fresh research session can answer about the codebase as it exists today.
...
Next step: start a fresh session with `qrspi/skills/v2/create_research.md`.
