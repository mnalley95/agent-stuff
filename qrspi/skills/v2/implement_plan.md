...
This stage decomposes old RPI **Implement** into the actual code-change session after worktree setup. You implement an approved plan from `thoughts/shared/plans/` with verification and human checkpoints.
...
3. Start a fresh session with `qrspi/skills/v2/describe_pr.md` to generate/update the PR description.
```
