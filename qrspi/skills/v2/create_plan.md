...
This stage is the final substage of old RPI **Plan**: convert the approved design and structure into a complete, actionable implementation plan for a fresh implementation agent.
...
Next step: start a fresh session with `qrspi/skills/v2/create_worktree.md`.
