...
```text
.agents/skills/create-questions/SKILL.md
.agents/skills/create-research/SKILL.md
.agents/skills/create-design/SKILL.md
.agents/skills/create-structure/SKILL.md
.agents/skills/create-plan/SKILL.md
.agents/skills/create-worktree/SKILL.md
.agents/skills/implement-plan/SKILL.md
.agents/skills/describe-pr/SKILL.md
```
...
Prepares an isolated implementation worktree and prints the exact next-session handoff: the worktree directory to open and the `implement-plan` skill invocation to send with the relative plan path.
...
```text
.agents/skills/create-questions [task/ticket]
.agents/skills/create-research thoughts/shared/questions/...
.agents/skills/create-design thoughts/shared/research/...
.agents/skills/create-structure thoughts/shared/designs/...
.agents/skills/create-plan thoughts/shared/structures/...
.agents/skills/create-worktree thoughts/shared/plans/...
cd [worktree printed by create-worktree.md]
.agents/skills/implement-plan thoughts/shared/plans/...
.agents/skills/describe-pr
```
