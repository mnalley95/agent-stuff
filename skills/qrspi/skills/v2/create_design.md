...
This stage decomposes old RPI **Plan** into the first planning substage: turn the task and research into an explicit design discussion, resolve human-judgment questions, and record the chosen approach.
...
Next step: start a fresh session with `qrspi/skills/v2/create_structure.md`.
