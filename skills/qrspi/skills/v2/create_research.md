...
This stage is the second half of old RPI **Research**: answer objective questions by documenting the codebase as it exists today. The result becomes compressed context for later design, structure, and plan sessions.
...
Next step: start a fresh session with `qrspi/skills/v2/create_design.md`.
